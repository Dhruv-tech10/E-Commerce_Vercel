...
const FILTER_CONFIG = {
  ...
  color: ["Black", "Silver", "Gray", "Blue", "White", "Red", "Gold"]
};
...
function Asus() {
  ...
  let filteredProducts = products.filter(p => 
    ...
    p.name?.toLowerCase().includes("proart")
  );
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-800 text-white text-center py-12">
        <h1 className="text-4xl font-bold">Asus Laptops</h1>
       
      </div>
<nav className="flex items-center gap-2 text-sm text-gray-500 mt-3 !pl-7">
          <Link to="/" className="!text-lg !no-underline !font-semibold !text-[#1E2D42] transition-colors">Home</Link>
          <span className="text-lg !font-medium">/</span>
          <span className="text-lg !font-medium text-[#E4921A]">Asus Laptops</span>
        </nav>
        <h2 className="text-2xl !font-bold !mt-3 !mb-3 !pl-7">Asus Laptops</h2>
          ...
          <div className="flex-1">
            ...
            {filteredProducts.length === 0 ? (
              <div className="bg-white rounded-xl p-12 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">No Asus Laptops Found</h3>
