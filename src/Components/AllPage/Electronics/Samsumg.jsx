...
const FILTER_CONFIG = {
  ...
  color: ["Black", "White", "Silver", "Gold", "Blue", "Green", "Purple", "Rose Gold", "Navy Blue"],
  camera: ["48MP", "50MP", "64MP", "108MP", "200MP"],
  battery: ["4000mAh", "4500mAh", "5000mAh", "5500mAh", "6000mAh", "7000mAh"]
};
...
function Samsung() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-blue-600 to-indigo-800 text-white text-center py-12">
        <h1 className="text-4xl font-bold"> Samsung Galaxy Collection</h1>
        <p className="mt-2 text-white/80">Premium Samsung Smartphones with Cutting-Edge Technology</p>
        <div className="mt-4 flex justify-center gap-3 flex-wrap">
          <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-xs">Galaxy S Series</span>
          <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-xs">Galaxy Z Fold/Flip</span>
          <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-xs">Galaxy A Series</span>
          <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-xs">Galaxy M Series</span>
          <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-xs">Galaxy Note</span>
        </div>
      </div>
      <nav className="flex items-center gap-2 text-sm text-gray-500 mt-3 !pl-7">
          <Link to="/" className="!text-lg !no-underline !font-semibold !text-[#1E2D42] transition-colors">Home</Link>
          <span className="text-lg !font-medium">/</span>
          <span className="text-lg !font-medium text-[#E4921A]">Samsung</span>
        </nav>
        <h2 className="text-2xl !font-bold !mt-3 !mb-3 !pl-7">Samsung</h2>
          ...
          <div className="flex-1">
            ...
            {filteredProducts.length === 0 ? (
              <div className="bg-white rounded-xl p-12 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">No Samsung Products Found</h3>
