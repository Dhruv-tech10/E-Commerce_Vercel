...
const FILTER_CONFIG = {
  ...
  color: ["Black", "Silver", "Gray", "Blue", "White", "Green"]
};
...
function Lenovo() {
  ...
  let filteredProducts = products.filter(p => 
    ...
    p.name?.toLowerCase().includes("thinkbook")
  );
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="bg-gradient-to-r from-red-600 to-red-800 text-white text-center py-12">
        <h1 className="text-4xl font-bold">Lenovo Laptops</h1>
       
      </div>
      <nav className="flex items-center gap-2 text-sm text-gray-500 mt-3 !pl-7">
          <Link to="/" className="!text-lg !no-underline !font-semibold !text-[#1E2D42] transition-colors">Home</Link>
          <span className="text-lg !font-medium">/</span>
          <span className="text-lg !font-medium text-[#E4921A]">Lenovo Laptops</span>
        </nav>
        <h2 className="text-2xl !font-bold !mt-3 !mb-3 !pl-7">Lenovo Laptops</h2>
          ...
          <div className="flex-1">
            ...
            {filteredProducts.length === 0 ? (
              <div className="bg-white rounded-xl p-12 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">No Lenovo Laptops Found</h3>
