...
const FILTER_CONFIG = {
  brand: ["Philips", "Bajaj", "Usha", "Havells", "Prestige", "Wonderchef", "Panasonic", "Supertron", "Kent", "Inalsa", "Butterfly", "Morphy Richards", "Maharaja Whiteline", "Orient", "Crompton", "V-Guard", "Singer", "Kenstar"],
  type: ["Centrifugal Juicer", "Masticating Juicer", "Slow Juicer", "Citrus Juicer", "Juicer Mixer Grinder", "Portable Juicer", "Cold Press Juicer", "Juicer Blender Combo"],
  capacity: ["0.5L", "1L", "1.5L", "2L", "2.5L", "3L", "3.5L", "4L", "5L"],
  wattage: ["200W", "250W", "300W", "350W", "400W", "450W", "500W", "600W", "700W", "750W", "800W", "900W", "1000W"],
  color: ["White", "Black", "Silver", "Red", "Blue", "Green", "Orange", "Gray", "Maroon", "Multicolor"],
  material: ["Stainless Steel", "Plastic", "ABS Plastic", "Glass", "Tritan", "Aluminum", "Copper Winding"],
  speedSettings: ["Single Speed", "2 Speeds", "3 Speeds", "Variable Speed", "Pulse Function"],
  features: ["Pulp Control", "Anti-Drip Spout", "Foam Separator", "Safety Lock", "Overload Protection", "Easy Clean", "Dishwasher Safe Parts", "Large Feeding Chute", "Juice Jug", "Filter Cleaning Brush", "Non-Slip Feet", "Cord Storage"]
};
...
function JuiceMachine() {
  ...
  let filteredProducts = products.filter(p => 
    p.category?.toLowerCase() === "juicer" ||
    p.subCategory?.toLowerCase() === "juicer" ||
    p.name?.toLowerCase().includes("juicer") ||
    p.name?.toLowerCase().includes("juice maker")
  );
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="mx-4 my-4 !shadow-3xl shadow-red-900/30 bg-[#1E2D42] bg-gradient-to-br from-[#EE971D] to-[#1E2D42] rounded-xl text-white text-center py-12 ">
        <h1 className="text-4xl font-bold">Juicer Machines</h1>
   
      </div>
      <nav className="flex items-center gap-2 text-sm text-gray-500 mt-3 !pl-7">
          <Link to="/" className="!text-lg !no-underline !font-semibold !text-[#1E2D42] transition-colors">Home</Link>
          <span className="text-lg !font-medium">/</span>
          <span className="text-lg !font-medium text-[#E4921A]">Juicers Machines</span>
        </nav>
        <h2 className="text-2xl !font-bold !mt-3 !mb-3 !pl-7">Juicers Machines</h2>
          ...
          <div className="flex-1">
            ...
            {filteredProducts.length === 0 ? (
              <div className="bg-white rounded-xl p-12 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">No Juicers Found</h3>
