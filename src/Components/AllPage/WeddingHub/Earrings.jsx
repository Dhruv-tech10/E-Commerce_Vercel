...
function Earrings() {
  ...
  const FILTER_CONFIG = {
    types: ["Stud Earrings", "Hoop Earrings", "Dangle Earrings", "Drop Earrings", "Chandelier Earrings"],
  ...
  const earringsProducts = products
    .filter((p) => p.category?.trim().toLowerCase() === "earrings")
    .filter((product) => {
  ...
  <nav className="flex items-center gap-2 text-sm text-gray-500 mt-3 !pl-7">
          ...
          <span className="text-lg !font-medium text-[#E4921A]">Earrings</span>
        </nav>
        <h2 className="text-2xl !font-bold !mt-3 !mb-3 !pl-7">Earrings</h2>
      <div className="max-w-7xl mx-auto flex gap-6 p-4">
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-bold mb-6">Earrings</h1>
