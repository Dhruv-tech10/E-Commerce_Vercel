...
const FILTER_CONFIG = {
  ...
  // Color
  color: ["Black", "Brown", "Tan", "Navy", "Burgundy", "Dark Brown", "Cognac"],
  
  // Material
  material: ["Leather", "Patent Leather", "Suede", "Faux Leather", "Synthetic", "PU Leather"],
  

  
  // Brands
  brands: [
    "Bata", "Hush Puppies", "Clarks", "Red Tape", "Woodland", 
    "Metro", "Lee Cooper", "Allen Solly", "Louis Philippe", "Van Heusen",
    "Nike", "Adidas", "Puma", "Reebok", "Campus"
  ]
};

function FormallShoes() {
  ...
  // ✅ ONLY FORMAL SHOES PRODUCTS
  let filteredProducts = products.filter(
    (p) => p.category === "Formal Shoes"
  );
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="mx-4 my-4 !shadow-3xl shadow-red-900/30 bg-[#1E2D42] bg-gradient-to-br from-[#EE971D] to-[#1E2D42] rounded-xl text-white text-center py-12 ">
        <h1 className="text-3xl font-bold">Men's Formal Shoes Collection</h1>
        <p className="mt-2 text-white/80 text-sm">Elevate Your Style with Premium Formal Footwear</p>
      </div>

        <nav className="flex items-center gap-2 text-sm text-gray-500 mt-3 !pl-7">
            <Link to="/" className="!text-lg !no-underline !font-semibold !text-[#1E2D42] transition-colors">Home</Link>
            <span className="text-lg !font-medium">/</span>
            <span className="text-lg !font-medium text-[#E4921A]">Men's Formal Shoes</span>
          </nav>
          <h2 className="text-2xl !font-bold !mt-3 !mb-3 !pl-7">Men's Formal Shoes</h2>
          ...
          <div className="flex-1">
            ...
            {filteredProducts.length === 0 ? (
              <div className="bg-white rounded-xl shadow-sm p-12 text-center">
                ...
                <p className="text-gray-500 text-sm">No Formal Shoes found matching your filters.</p>
                <button 
