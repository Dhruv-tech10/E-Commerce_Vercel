...
// ✅ SIRF 3 FILTERS - Fabric, Combo, Price
const FILTER_CONFIG = {
  // Fabric Filter
  fabric: [
...
function TShirt() {
  ...
  // ✅ FILTER T-SHIRTS PRODUCTS
  let filteredProducts = products.filter((p) => p.category === "T-Shirts");
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col">
      ...
      <div className="mx-4 my-4 !shadow-3xl shadow-red-900/30 bg-[#1E2D42] bg-gradient-to-br from-[#EE971D] to-[#1E2D42] rounded-xl text-white text-center py-12 ">
        ...
        <p className="mt-2 text-white/80 text-sm">Comfortable & Stylish T-Shirts for Every Occasion</p>
      </div>
      ...
      <h2 className="text-2xl !font-bold !mt-3 !mb-3 !pl-7 flex-shrink-0">T-Shirts</h2>
          ...
          <div className="flex-1">
            ...
            {filteredProducts.length === 0 ? (
              <div className="bg-white rounded-xl shadow-sm p-12 text-center">
                ...
                <p className="text-gray-500 text-sm">No T-Shirts found matching your filters.</p>
                <button 
