...
function MenCaps() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="bg-gradient-to-r from-teal-600 to-blue-700 text-white text-center py-8"><h1 className="text-3xl font-bold">Men's Caps Collection</h1><p className="mt-2 text-white/80 text-sm">Complete Your Look</p></div>
