...
function Cargos() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      {/* HEADER BANNER */}
      <div className="bg-gradient-to-r from-green-600 to-teal-600 text-white text-center py-8">
...
<nav className="flex items-center gap-2 text-sm text-gray-500 mt-3 !pl-7">
          ...
          <h2 className="text-2xl !font-bold !mt-3 !mb-3 !pl-7">Men's Cargo Pants</h2>
