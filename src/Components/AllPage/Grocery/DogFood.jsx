...
function DogFood() {
  ...
  const FILTER_CONFIG = {
    typeOptions: ["Dry Dog Food", "Wet Dog Food", "Puppy Food", "Senior Dog Food", "Grain Free", "Organic Dog Food"],
    brandOptions: ["Pedigree", "Drools", "Farmina", "Royal Canin", "Hill's Science Diet", "Purina"],
  };
  ...
  const sampleProducts = [
    { 
      ...
      price: 699, 
      offerPrice: 649, 
      image: "https://m.media-amazon.com/images/I/71yK8r2oW9L._SL1500_.jpg", 
      rating: 4.5 
    },
    { 
      id: 2, 
    ...
    { 
      id: 4, 
      name: "Farmina Grain Free Dog Food", 
      category: "Dog Food", 
      type: "Grain Free", 
      brand: "Farmina", 
      price: 1499, 
    ...
    { 
      id: 5, 
      name: "Purina Organic Dog Food", 
      category: "Dog Food", 
      type: "Organic Dog Food", 
      brand: "Purina", 
      price: 1099, 
      offerPrice: 999, 
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <nav className="flex items-center gap-2 text-sm text-gray-500 mt-3 !pl-7">
        ...
        <span className="text-lg !font-medium text-[#E4921A]">Dog Food</span>
      </nav>
      <h2 className="text-2xl !font-bold !mt-3 !mb-3 !pl-7">Dog Food</h2>
      <div className="max-w-7xl mx-auto p-4 flex gap-6">
        <div className="w-72 bg-white p-4 rounded-xl shadow-sm">
          ...
          <FilterDropdown title="Dog Food Type" filterKey="type" options={FILTER_CONFIG.typeOptions} />
            ...
            {openDropdown.price && (
              <div className="mt-4 px-1">
                ...
                <div className="relative w-full h-1 bg-gray-300 rounded-full mt-1">
                  <div className="absolute h-1 bg-orange-500 rounded-full" style={{ width: `${(maxPrice / 1500) * 100}%` }} />
                  <input type="range" min="0" max="1500" step="10" value={maxPrice} onChange={handlePriceChange} className="absolute w-full h-1 opacity-0 cursor-pointer z-10" />
                  <div className="absolute top-1/2 -mt-3 w-6 h-6 bg-orange-500 rounded-full shadow-md z-5 pointer-events-none" style={{ left: `calc(${(maxPrice / 1500) * 100}% - 12px)` }} />
                </div>
                <div className="flex justify-between mt-3 text-xs text-gray-400 font-medium"><span>₹0</span><span>₹300</span><span>₹600</span><span>₹900</span><span>₹1200</span><span>₹1500</span></div>
              </div>
            )}
          </div>
        </div>
        <div className="flex-1">
          <h1 className="text-3xl font-bold mb-6">Dog Food</h1>
          {filteredProducts.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-96 text-center">
              ...
              <h2 className="text-2xl font-bold text-gray-500 mb-2">No Dog Food Products Found</h2>
