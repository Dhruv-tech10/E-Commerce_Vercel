...
function ChipsNamkeen() {
  ...
  const getFilteredProducts = () => {
    let filtered = products.filter((p) => p.category === "Snacks Namkeens" || p.category === "Grocery");
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <nav className="flex items-center gap-2 text-sm text-gray-500 mt-3 !pl-7">
        ...
        <span className="text-lg !font-medium text-[#E4921A]">Chips & Namkeen</span>
      </nav>
      <h2 className="text-2xl !font-bold !mt-3 !mb-3 !pl-7">Chips & Namkeen</h2>
          ...
          {filteredProducts.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-96 text-center">
              ...
              <p className="text-gray-400 mb-4 max-w-md">
                {hasActiveFilters ? "We couldn't find any products matching your selected filters." : "No snacks products are available at the moment."}
              </p>
              {hasActiveFilters && (
