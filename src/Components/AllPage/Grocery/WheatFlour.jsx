...
function WheatFlour() {
  ...
  const FILTER_CONFIG = {
    typeOptions: ["Whole Wheat Flour", "Refined Flour (Maida)", "Multigrain Flour", "Chakki Fresh", "Organic Flour", "Gluten Free Flour"],
    brandOptions: ["Tata Sampann", "Patanjali", "Fortune", "Pillsbury", "Shakti Bhog", "Ashoka"],
  };
  ...
  const sampleProducts = [
    { 
      id: 1, 
      name: "Tata Sampann Whole Wheat Flour", 
      category: "Wheat Flour", 
      type: "Whole Wheat Flour", 
      brand: "Tata Sampann", 
      price: 199, 
      offerPrice: 179, 
      image: "https://m.media-amazon.com/images/I/71vJ2qMxP2L._SL1500_.jpg", 
      rating: 4.5 
    },
    { 
      id: 2, 
      name: "Patanjali Chakki Fresh Atta", 
      category: "Wheat Flour", 
      type: "Chakki Fresh", 
      brand: "Patanjali", 
      price: 149, 
      offerPrice: 139, 
      image: "https://m.media-amazon.com/images/I/71hCh0qGxQL._SL1500_.jpg", 
      rating: 4.3 
    },
    { 
      id: 3, 
      name: "Fortune Multigrain Flour", 
      category: "Wheat Flour", 
    ...
    { 
      id: 4, 
      name: "Pillsbury Organic Flour", 
      category: "Wheat Flour", 
      type: "Organic Flour", 
      brand: "Pillsbury", 
      price: 299, 
      offerPrice: 279, 
      image: "https://m.media-amazon.com/images/I/71R4W5Z8v4L._SL1500_.jpg", 
      rating: 4.6 
    },
    { 
      id: 5, 
      name: "Shakti Bhog Maida", 
      category: "Wheat Flour", 
      type: "Refined Flour (Maida)", 
      brand: "Shakti Bhog", 
      price: 159, 
      offerPrice: 149, 
      image: "https://m.media-amazon.com/images/I/71J1W2MqU8L._SL1500_.jpg", 
      rating: 4.2 
    },
  ];
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <nav className="flex items-center gap-2 text-sm text-gray-500 mt-3 !pl-7">
            ...
            <span className="text-lg !font-medium text-[#E4921A]">Wheat Flour</span>
          </nav>
          <h2 className="text-2xl !font-bold !mt-3 !mb-3 !pl-7">Wheat Flour</h2>
      <div className="max-w-7xl mx-auto p-4 flex gap-6">
        <div className="w-72 bg-white p-4 rounded-xl shadow-sm">
          ...
          <FilterDropdown title="Flour Type" filterKey="type" options={FILTER_CONFIG.typeOptions} />
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-bold mb-6">Wheat Flour</h1>
          {filteredProducts.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-96 text-center">
              ...
              <h2 className="text-2xl font-bold text-gray-500 mb-2">No Flour Products Found</h2>
