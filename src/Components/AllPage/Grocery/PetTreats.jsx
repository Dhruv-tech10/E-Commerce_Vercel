...
function PetTreats() {
  ...
  const FILTER_CONFIG = {
    typeOptions: ["Dog Treats", "Cat Treats", "Biscuits", "Chew Sticks", "Training Treats", "Natural Treats", "Organic Treats"],
    brandOptions: ["Pedigree", "Whiskas", "Drools", "Farmina", "Purina", "Royal Canin"],
  };
  ...
  const sampleProducts = [
    { 
      ...
      price: 299, 
      offerPrice: 279, 
      image: "https://m.media-amazon.com/images/I/71J+XvCbBkL._SL1500_.jpg", 
      rating: 4.5 
    },
    { 
      id: 2, 
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <nav className="flex items-center gap-2 text-sm text-gray-500 mt-3 !pl-7">
          ...
          <span className="text-lg !font-medium text-[#E4921A]">Pet Treats</span>
        </nav>
        <h2 className="text-2xl !font-bold !mt-3 !mb-3 !pl-7">Pet Treats</h2>
      <div className="max-w-7xl mx-auto p-4 flex gap-6">
        <div className="w-72 bg-white p-4 rounded-xl shadow-sm">
          ...
          <FilterDropdown title="Treat Type" filterKey="type" options={FILTER_CONFIG.typeOptions} />
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-bold mb-6">Pet Treats</h1>
          {filteredProducts.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-96 text-center">
              ...
              <h2 className="text-2xl font-bold text-gray-500 mb-2">No Treats Products Found</h2>
