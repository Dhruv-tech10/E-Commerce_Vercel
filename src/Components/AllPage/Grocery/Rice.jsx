...
function Rice() {
  ...
  const FILTER_CONFIG = {
    typeOptions: ["Basmati Rice", "Sona Masoori", "Brown Rice", "Parboiled Rice", "Jasmine Rice", "Ponni Rice", "Long Grain", "Short Grain"],
    brandOptions: ["Tata Sampann", "Daawat", "Fortune", "Lakshmi", "India Gate", "Patanjali", "24 Mantra", "Organic India"],
  };

  const [maxPrice, setMaxPrice] = useState(1000);

  // ✅ FIX: Directly use sample products with images
  const sampleProducts = [
    { 
      ...
      price: 499, 
      offerPrice: 449, 
      image: "https://m.media-amazon.com/images/I/71qA9a4yHtL._SL1500_.jpg", 
      rating: 4.5 
    },
    { 
      id: 2, 
      ...
      price: 599, 
      offerPrice: 549, 
      image: "https://m.media-amazon.com/images/I/71A8V-O9vCL._SL1500_.jpg", 
      rating: 4.4 
    },
    { 
      id: 3, 
      ...
      price: 399, 
      offerPrice: 349, 
      image: "https://m.media-amazon.com/images/I/71J8Vv5+3fL._SL1500_.jpg", 
      rating: 4.3 
    },
    { 
      id: 4, 
      ...
      price: 699, 
      offerPrice: 649, 
      image: "https://m.media-amazon.com/images/I/71bLq9xU4uL._SL1500_.jpg", 
      rating: 4.6 
    },
    { 
      id: 5, 
      ...
      price: 449, 
      offerPrice: 399, 
      image: "https://m.media-amazon.com/images/I/71QWA2tD4XL._SL1500_.jpg", 
      rating: 4.2 
    },
    { 
      id: 6, 
      name: "24 Mantra Organic Rice", 
      category: "Rice", 
      type: "Basmati Rice", 
      brand: "24 Mantra", 
      price: 799, 
  ...
  // ✅ FIX: Directly use sample products, no API call
  useEffect(() => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <nav className="flex items-center gap-2 text-sm text-gray-500 mt-3 !pl-7">
          ...
          <span className="text-lg !font-medium text-[#E4921A]">Rice</span>
        </nav>
        <h2 className="text-2xl !font-bold !mt-3 !mb-3 !pl-7">Rice</h2>
      <div className="max-w-7xl mx-auto p-4 flex gap-6">
        <div className="w-72 bg-white p-4 rounded-xl shadow-sm">
          ...
          <FilterDropdown title="Rice Type" filterKey="type" options={FILTER_CONFIG.typeOptions} />
            ...
            {openDropdown.price && (
              <div className="mt-4 px-1">
                ...
                <div className="relative w-full h-1 bg-gray-300 rounded-full mt-1">
                  ...
                  <input type="range" min="0" max="1000" step="1" value={maxPrice} onChange={handlePriceChange} className="absolute w-full h-1 opacity-0 cursor-pointer z-10" />
                ...
                <div className="flex justify-between mt-3 text-xs text-gray-400 font-medium"><span>₹0</span><span>₹250</span><span>₹500</span><span>₹750</span><span>₹1000</span></div>
              </div>
            )}
          </div>
        </div>
        <div className="flex-1">
          <h1 className="text-3xl font-bold mb-6">Rice</h1>
          {filteredProducts.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-96 text-center">
              ...
              <h2 className="text-2xl font-bold text-gray-500 mb-2">No Rice Products Found</h2>
              <p className="text-gray-400 mb-4">Try adjusting your filters or clear all filters</p>
