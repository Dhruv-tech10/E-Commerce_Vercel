...
function PulsesDal() {
  ...
  const FILTER_CONFIG = {
    typeOptions: ["Toor Dal", "Moong Dal", "Masoor Dal", "Urad Dal", "Chana Dal", "Arhar Dal", "Mixed Dal", "Green Moong"],
    brandOptions: ["Tata Sampann", "Patanjali", "Fortune", "Lakshmi", "Deepak", "Healthy Life"],
  };
  ...
  const sampleProducts = [
    ...
    { 
      ...
      price: 139, 
      offerPrice: 129, 
      image: "https://m.media-amazon.com/images/I/71H8vV5+3fL._SL1500_.jpg", 
      rating: 4.4 
    },
    { 
      id: 4, 
      name: "Lakshmi Urad Dal", 
      category: "Pulses", 
      type: "Urad Dal", 
      brand: "Lakshmi", 
      price: 179, 
  ...
  const getFilteredProducts = () => {
    let filtered = products.filter((p) => 
      ...
      p.category?.toLowerCase().includes("dal")
    );
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <nav className="flex items-center gap-2 text-sm text-gray-500 mt-3 !pl-7">
          ...
          <span className="text-lg !font-medium text-[#E4921A]">Pulses & Dal</span>
        </nav>
        <h2 className="text-2xl !font-bold !mt-3 !mb-3 !pl-7">Pulses & Dal</h2>
      <div className="max-w-7xl mx-auto p-4 flex gap-6">
        <div className="w-72 bg-white p-4 rounded-xl shadow-sm">
          ...
          <FilterDropdown title="Dal Type" filterKey="type" options={FILTER_CONFIG.typeOptions} />
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-bold mb-6">Pulses & Dal</h1>
          {filteredProducts.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-96 text-center">
              ...
              <h2 className="text-2xl font-bold text-gray-500 mb-2">No Dal Products Found</h2>
