...
function SaltSpices() {
  ...
  const FILTER_CONFIG = {
    typeOptions: ["Table Salt", "Rock Salt", "Black Salt", "Sea Salt", "Iodized Salt", "Himalayan Pink Salt", "Spice Mix", "Seasoning"],
    brandOptions: ["Tata Salt", "Patanjali", "Catch", "MDH", "Everest", "Shan"],
  };
  ...
  const sampleProducts = [
    { 
      ...
      price: 199, 
      offerPrice: 179, 
      image: "https://m.media-amazon.com/images/I/71r8YcO+owL._SL1500_.jpg", 
      rating: 4.5 
    },
    { 
      id: 2, 
      name: "Patanjali Himalayan Pink Salt", 
      category: "Salt", 
  ...
  const getFilteredProducts = () => {
    let filtered = products.filter((p) => 
      ...
      p.category === "Spices" ||
      p.category === "Grocery" ||
      p.category?.toLowerCase().includes("salt") ||
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <nav className="flex items-center gap-2 text-sm text-gray-500 mt-3 !pl-7">
          ...
          <span className="text-lg !font-medium text-[#E4921A]">Salt & Spices</span>
        </nav>
        <h2 className="text-2xl !font-bold !mt-3 !mb-3 !pl-7">Salt & Spices</h2>
      <div className="max-w-7xl mx-auto p-4 flex gap-6">
        <div className="w-72 bg-white p-4 rounded-xl shadow-sm">
          ...
          <FilterDropdown title="Salt & Spice Type" filterKey="type" options={FILTER_CONFIG.typeOptions} />
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-bold mb-6">Salt & Spices</h1>
          {filteredProducts.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-96 text-center">
              ...
              <h2 className="text-2xl font-bold text-gray-500 mb-2">No Salt Products Found</h2>
