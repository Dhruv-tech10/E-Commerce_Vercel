...
function WomenBra() {
  ...
  const womenBraProducts = products
    .filter((p) => p.category?.trim().toLowerCase() === "women bra")
    .filter((product) => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <nav className="flex items-center gap-2 text-sm text-gray-500 mt-3 !pl-7">
            ...
            <span className="text-lg !font-medium text-[#E4921A]">Women Bra</span>
          </nav>
          <h2 className="text-2xl !font-bold !mt-3 !mb-3 !pl-7">Bra</h2>
        ...
        <div className="flex-1">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {womenBraProducts.length > 0 ? (
              ...
              <p className="text-gray-500">No Bra Found</p>
            )}
          </div>
        </div>
