// src/component/WomenWatches.jsx
...
function Watch() {
  ...
  const FILTER_CONFIG = {
    types: ["Analog Watches", "Digital Watches", "Sport Watches", "Smart Watches", "Fashion Watches"],
    materials: ["Stainless Steel", "Leather", "Silicone", "Gold", "Silver", "Rose Gold"],
  ...
  const womenWatchesProducts = products
    .filter((p) => p.category?.trim().toLowerCase() === "women watches")
    .filter((product) => {
    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto flex gap-6 p-4">
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-bold mb-6">Women Watches</h1>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {womenWatchesProducts.length > 0 ? (
              womenWatchesProducts.map((product) => (
