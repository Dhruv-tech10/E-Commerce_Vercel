    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white text-center py-12">
        ...
        <div className="mt-4 flex justify-center gap-3 flex-wrap">
          <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-xs">Storage Bins</span>
          <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-xs">Stackable Boxes</span>
          <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-xs">Under Bed Storage</span>
          <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-xs">Closet Organizers</span>
        </div>
      </div>
