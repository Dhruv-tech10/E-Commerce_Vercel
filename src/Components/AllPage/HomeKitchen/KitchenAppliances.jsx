// src/component/KitchenAppliances.jsx
...
const FILTER_CONFIG = {
  material: ["Plastic", "Stainless Steel", "Glass", "Aluminum", "Copper"],
  color: ["Black", "White", "Silver", "Red", "Blue", "Green", "Multicolor"],
  sizes: ["Small", "Medium", "Large", "Compact", "Family Size"],
  brands: ["Prestige", "Pigeon", "Butterfly", "Havells", "Bajaj", "Philips", "Panasonic"]
};
...
function KitchenAppliances() {
  ...
  let filteredProducts = products.filter(p => 
    p.category?.toLowerCase() === "kitchenappliances" || 
    p.subCategory?.toLowerCase() === "kitchen-appliances" ||
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <div className="mx-4 my-4 !shadow-3xl shadow-red-900/30 bg-[#1E2D42] bg-gradient-to-br from-[#EE971D] to-[#1E2D42] rounded-xl text-white text-center py-12 ">
        ...
        <p className="mt-2 text-white/80">Powerful appliances to make cooking easier</p>
      </div>
      <nav className="flex items-center gap-2 text-sm text-gray-500 mt-3 !pl-7">
            <Link to="/" className="!text-lg !no-underline !font-semibold !text-[#1E2D42] transition-colors">Home</Link>
            <span className="text-lg !font-medium">/</span>
            <span className="text-lg !font-medium text-[#E4921A]">Kitchen Appliances</span>
          </nav>
          <h2 className="text-2xl !font-bold !mt-3 !mb-3 !pl-7">Kitchen Appliances</h2>
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1">
            ...
            {filteredProducts.length === 0 ? (
              <div className="bg-white rounded-xl p-12 text-center"><div className="text-5xl mb-4"></div>No Kitchen Appliances found.</div>
            ) : (
