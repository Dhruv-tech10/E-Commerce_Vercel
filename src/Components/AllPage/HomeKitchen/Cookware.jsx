...
const FILTER_CONFIG = {
  material: ["Non-stick", "Stainless Steel", "Cast Iron", "Aluminum", "Copper", "Ceramic", "Glass"],
  color: ["Black", "Silver", "Red", "Blue", "Green", "White", "Multicolor"],
  sizes: ["Small", "Medium", "Large", "Set of 2", "Set of 3", "Set of 5", "Set of 7"],
  brands: ["Prestige", "Pigeon", "Hawkins", "Butterfly", "Wonderchef", "Cello", "Borosil"]
};
...
function Cookware() {
  ...
  let filteredProducts = products.filter(p => 
    p.category?.toLowerCase() === "cookware" || 
    p.subCategory?.toLowerCase() === "cookware" ||
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <nav className="flex items-center gap-2 text-sm text-gray-500 mt-3 !pl-7">
            ...
            <span className="text-lg !font-medium text-[#E4921A]">Cookware</span>
          </nav>
          <h2 className="text-2xl !font-bold !mt-3 !mb-3 !pl-7">Cookware</h2>
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1">
            ...
            {filteredProducts.length === 0 ? (
              <div className="bg-white rounded-xl p-12 text-center"><div className="text-5xl mb-4"></div>No Cookware found.</div>
            ) : (
