    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white text-center py-12">
        ...
        <div className="mt-4 flex justify-center gap-3 flex-wrap">
          <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-xs">Memory Foam</span>
          <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-xs">Spring Mattress</span>
          <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-xs">Orthopedic</span>
          <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-xs">Hybrid Mattress</span>
        </div>
      </div>
