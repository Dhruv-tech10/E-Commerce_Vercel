// src/component/ArtificialPlants.jsx
...
const FILTER_CONFIG = {
  material: ["Plastic", "Silk", "Polyester", "Fabric", "Foam", "Paper", "Clay"],
  color: ["Green", "Mixed", "Red", "Yellow", "White", "Pink", "Purple"],
  sizes: ["Small", "Medium", "Large", "Extra Large", "Tabletop", "Floor Standing"],
  brands: ["IKEA", "Home Centre", "Pepperfry", "Urban Ladder", "Amazon Basics"]
};

function ArtificialFlowers() {
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1">
            ...
            {filteredProducts.length === 0 ? (
              <div className="bg-white rounded-xl p-12 text-center"><div className="text-5xl mb-4"></div>No Artificial Plants found.</div>
            ) : (
...
export default ArtificialFlowers;