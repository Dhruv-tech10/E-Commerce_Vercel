...
const FILTER_CONFIG = {
  material: ["Brass", "Copper", "Silver", "Wood", "Clay", "Metal", "Plastic", "Glass", "Stone"],
  color: ["Gold", "Silver", "Brown", "Red", "Yellow", "Multicolor", "White", "Black"],
  sizes: ["Small", "Medium", "Large", "Extra Large", "Portable"],
  brands: ["Puja Store", "Amazon", "Home Centre", "Urban Ladder", "Traditional Bazaar"]
};
...
function PoojaNeeds() {
  ...
  let filteredProducts = products.filter(
    (p) => p.category?.toLowerCase() === "poojaneeds" || 
           p.subCategory?.toLowerCase() === "pooja-needs" ||
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white text-center py-12">
        <h1 className="text-4xl font-bold"> Pooja Needs Collection</h1>
        <p className="mt-2 text-white/80">Complete pooja essentials for your daily worship</p>
      </div>

      <nav className="flex items-center gap-2 text-sm text-gray-500 mt-3 !pl-7">
            <Link to="/" className="!text-lg !no-underline !font-semibold !text-[#1E2D42] transition-colors">Home</Link>
            <span className="text-lg !font-medium">/</span>
            <span className="text-lg !font-medium text-[#E4921A]">Pooja Needs</span>
          </nav>
          <h2 className="text-2xl !font-bold !mt-3 !mb-3 !pl-7">Pooja Needs</h2>
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1">
            ...
            {filteredProducts.length === 0 ? (
              <div className="bg-white rounded-xl p-12 text-center"><div className="text-5xl mb-4"></div>No Pooja items found.</div>
            ) : (
