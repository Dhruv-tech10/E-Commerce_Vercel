    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white text-center py-12">
        ...
        <div className="mt-4 flex justify-center gap-3 flex-wrap">
          <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-xs">L-Shape Sofa</span>
          <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-xs">3 Seater Sofa</span>
          <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-xs">Recliner Sofa</span>
          <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-xs">Sofa Cum Bed</span>
        </div>
      </div>
