// src/Components/AllPage/Icons/IconAccessories.jsx
...
// ✅ ACCESSORIES FILTER CONFIG
const FILTER_CONFIG = {
  // Categories
  categories: [
    "Sunglasses", "Jewellery", "Belts", "Wallets", 
    "Caps", "Scarves", "Ties", "Cufflinks",
    "Necklace", "Bracelets", "Earrings", "Rings",
    "Anklets", "Pendants", "Chains", "Keychains",
    "Tie Bars", "Pocket Squares", "Hat", "Gloves",
    "Watch Straps", "Phone Cases", "Card Holders", "Money Clips"
  ],
  
  // Size
  sizes: ["One Size", "Small", "Medium", "Large", "Adjustable", "Free Size"],
  
  // Color
  colors: [
    "Black", "White", "Brown", "Gold", "Silver", 
    "Rose Gold", "Red", "Blue", "Green", "Yellow",
    "Pink", "Purple", "Orange", "Grey", "Tan",
    "Beige", "Maroon", "Navy", "Teal", "Multi-Color"
  ],
  
  // Material
  materials: [
    "Leather", "Gold Plated", "Silver", "Stainless Steel", 
    "Plastic", "Polycarbonate", "Acetate", "Wood",
    "Gemstone", "Diamond", "Crystal", "Pearl",
    "Fabric", "Cotton", "Wool", "Silk",
    "Metal", "Brass", "Copper", "Titanium",
    "Rhodium", "Enamel", "Resin", "Carbon Fiber"
  ],
  
  // Brands
  brands: [
    "Fastrack", "Titan", "Fossil", "Tommy Hilfiger", 
    "Calvin Klein", "Levi's", "Allen Solly", "Louis Philippe",
    "Van Heusen", "Nike", "Adidas", "Puma",
    "Ray-Ban", "Oakley", "Police", "Lenskart",
    "Tanishq", "PC Jeweller", "Kalyan Jewellers", "Malabar Gold",
    "Voylla", "Jewellery", "Baggit", "Caprese",
    "Wildcraft", "Decathlon", "Polo", "American Tourister"
  ]
};
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // ✅ Filter ALL Accessories products
        const accessoriesProducts = data.filter(p => {
          const category = p.category?.toLowerCase() || '';
          const name = p.name?.toLowerCase() || '';
          
          const accessoriesCategories = [
            'sunglass', 'sunglasses', 'jewellery', 'jewelry', 'belt', 'belts',
            'wallet', 'wallets', 'cap', 'caps', 'scarf', 'scarves', 'tie',
            'cufflink', 'necklace', 'bracelet', 'earring', 'ring', 'anklet',
            'pendant', 'chain', 'keychain', 'tie bar', 'pocket square', 'hat',
            'gloves', 'watch strap', 'phone case', 'card holder', 'money clip',
            'accessories', 'accessory', 'fashion accessory'
          ];
          
          return accessoriesCategories.some(accCat => 
            category.includes(accCat) || name.includes(accCat)
          );
        });
  ...
  const AccordionSection = ({ title, sectionKey, items }) => (
    <div className="mb-4 border-b border-gray-100 pb-3">
      <button 
        ...
        className="flex justify-between items-center w-full font-bold text-gray-800 text-sm mb-2 hover:text-amber-600 transition"
      >
        <span>{title}</span>
          ...
          {items.map((item, index) => (
            <label key={index} className="flex items-center gap-2 cursor-pointer hover:bg-gray-50 p-1 rounded">
              <input 
                ...
                className="w-3.5 h-3.5 !mr-2  rounded border-gray-300 text-amber-600 focus:ring-amber-500" 
              />
  ...
  const FilterSidebar = () => (
    <div className="bg-white p-4 rounded-xl shadow-sm">
      <div className="flex justify-between items-center mb-4 border-b pb-3">
        ...
        <button onClick={clearAllFilters} className="text-amber-600 text-xs font-semibold hover:underline">Clear All</button>
      </div>
          ...
          <Slider
            ...
            sx={{
              ...
              '& .MuiSlider-thumb': {
                ...
                '&:hover': { boxShadow: '0 0 0 8px rgba(217, 119, 6, 0.16)' }
              },
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="mx-4 my-4 !shadow-3xl shadow-red-900/30 bg-[#1E2D42] bg-gradient-to-br from-[#EE971D] to-[#1E2D42] rounded-xl text-white text-center py-12 ">
        ...
        <p className="mt-2 text-white/80 text-sm">Complete Your Look with Premium Accessories</p>
      </div>

      <nav className="flex items-center gap-2 text-sm text-gray-500 mt-3 pl-7">
        <Link to="/" className="text-lg !no-underline font-semibold !text-[#1E2D42] transition-colors">Home</Link>
        <span className="text-lg font-medium">/</span>
        <span className="text-lg font-medium text-[#E4921A]">Accessories Collection</span>
      </nav>
      <h2 className="text-2xl font-bold mt-3 mb-3 pl-7">Accessories Collection</h2>
          ...
          <div className="flex-1">
            <div className="bg-white rounded-xl shadow-sm p-3 mb-4 flex justify-between items-center flex-wrap gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <select 
                  ...
                  className="border rounded-lg px-3 py-1.5 text-xs font-medium focus:outline-none focus:border-amber-500"
                >
            ...
            {filteredProducts.length === 0 ? (
              <div className="bg-white rounded-xl shadow-sm p-12 text-center">
                ...
                <p className="text-gray-500 text-sm">No Accessories found matching your filters.</p>
                <button 
